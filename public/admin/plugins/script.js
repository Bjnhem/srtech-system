...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // (function () {
  //   var showCatBtns = document.querySelectorAll('.sidebar-body-menu li');

  //   // showCatBtns.forEach((item) => item.addEventListener('click', show_post_2));

  //   if (showCatBtns) {
  //     // showCatBtns.forEach(function () {

  //       showCatBtns.forEach((item) => item.addEventListener('mouseenter', function (e){
  //         var catSubMenu = e.nextElementSibling;
  //           e.preventDefault();
  ...
  (function () {
    ...
    if (showCatBtns) {
      showCatBtns.forEach(function (showCatBtn) {
        ...
        showCatBtn.addEventListener('mouseenter', function (e) {
          e.preventDefault();
          if(catSubMenu){
          catSubMenu.classList.toggle('visible');
          var catBtnToRotate = document.querySelector('.category__btn');
  ...
  function addData() {
    ...
    if (darkMode === 'enabled') {
     var gridLine = '#37374F';
       var titleColor = '#EFF0F6';
    } else {
     var gridLine = '#EEEEEE';
      var titleColor = '#171717';
    }
