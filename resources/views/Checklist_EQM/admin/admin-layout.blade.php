...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('pro3m/pro3m.css') }}" /> --}}
            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        <li>
                            <a class="show-cat-btn" href="{{ route('admin.checklist.edit') }}" id="overview">
                        ...
                        <li>
                            <a class="show-cat-btn" href="{{ route('admin.checklist.search') }}" id="overview2">
                                <span class="icon-line-check-square" style="padding-right:5px"
                                    aria-hidden="true"></span>
                                Checklist Pro-3M-Search
