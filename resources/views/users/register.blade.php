                     ...
                     <div class="card-body">
                        ...
                        <form method="POST" action="{{route('auth.submit.signup')}}" data-toggle="validator">
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input id="username" type="text" name="username"  value=""   class="form-control"  placeholder="" required autofocus>
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label for="part" class="form-label">Bộ phận</label>
                                    <input id="part" type="text" name="part"  value=""   class="form-control"  placeholder="" required autofocus>
                                 </div>
                              </div>
                           ...
                           <p class="mt-3 text-center">
                             Nếu đã có tài khoản?  <a href="{{route('auth.signin')}}" class="text-underline">Click để đăng nhập</a>
                           </p>
                        </form>
                     </div>
                  </div> 
