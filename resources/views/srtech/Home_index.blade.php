                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="icon-container">
                                            <img src="{{ asset('checklist-ilsung/icon/checklist-2.png') }}"
                                                alt="Checklist" width="50" height="50">
                                        </div>
                        ...
                        <a href="{{ route('WareHouse.chuyen.kho') }}">
                            <div class="card tech-card warehouse-card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="icon-container">
                                            <img src="{{ asset('checklist-ilsung/icon/warehouse.png') }}"
                                                alt="Warehouse" width="50" height="50">
                                        </div>
                                        <div class="card-content">
                                            <h3>WareHouse</h3>
                                            <p>Quản lý kho EQM</p>
