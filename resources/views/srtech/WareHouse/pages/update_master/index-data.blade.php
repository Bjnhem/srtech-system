                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                Danh sách model
                                <h2 class="counter" id="model-count" style="visibility: visible;">{{ $modelCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                Danh sách kho
                                <h2 class="counter" id="warehouse-count" style="visibility: visible;">{{ $warehouseCount }}
                                </h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                Sản phẩm
                                <h2 class="counter" id="product-count" style="visibility: visible;">{{ $productCount }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
