...
class CreateLineLossesTable extends Migration
{
    public function up()
    {
        Schema::create('line_losses', function (Blueprint $table) {
            ...
            $table->string('Code_ID'); // Loại lỗi (ví dụ: thiếu nguyên liệu, lỗi máy móc)
            $table->integer('prod_qty'); // Loại lỗi (ví dụ: thiếu nguyên liệu, lỗi máy móc)
            $table->integer('NG_qty'); // Loại lỗi (ví dụ: thiếu nguyên liệu, lỗi máy móc)
